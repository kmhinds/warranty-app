...
function App() {
  ...
  return (
    <div>
      ...
      <button className="button-base bg-green" onClick={() => renderCount(0)}>In warranty
      </button>
      <button className="button-base bg-red" onClick={() => renderCount(1)}>
          Out of warranty
      </button>
      <button className="button-base bg-blue" onClick={() => renderCount(2)}>
          Total Bad Units
      </button>
    </div>
  );
